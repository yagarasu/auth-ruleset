...
Entity          = "entity" , ws , Ident
                , [ ws , PrimaryGrouping , { ws , "," , ws , Grouping } ];
...
(* Rules *)
Rule            = Variable , ":" , Ident , [ Filters ] , ws
                , "{" , ws , { Permission } , ws , "}";
            
Filters         = "[" , ws , StrList , ws , "]" 
                , { "[" , ws , Ident , ws , ":" , ws , StrList , ws , "]" };

StrList         = LitString , { ws , "," , ws , LitString };

Permission      = "can" , ws , ["not"] , ws , PermissionIdent , 
                [ ws , Variable , ":" , Ident , { Variable , ":" , Ident } ] , ws
                , "{" , Conditionals , "}";
